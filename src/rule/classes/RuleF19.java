...
/**
 * La classe <code> RuleF19 </code> implemente la regle F19 contenue dans le
 * cahier des charges
 * 
 * @author Adan Bougherara et Vivien Demeulenaere
 *
 */
public class RuleF19 implements RuleI {
	...
	public ArrayList<EventI> match(EventBaseI eb) {
		EventI firstFire = null;
		EventI endFire = null;

		for (int i = 0; i < eb.numberOfEvents() && (firstFire == null || endFire == null); i++) {
		...
		if (firstFire != null && endFire != null) {
			ArrayList<EventI> matchedEvents = new ArrayList<>();
			matchedEvents.add(firstFire);
