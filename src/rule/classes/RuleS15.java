...
/**
 * La classe <code> RuleS15 </code> implemente la regle S15 contenue dans le
 * cahier des charges
 * 
 * @author Adan Bougherara et Vivien Demeulenaere
 *
 */
public class RuleS15 extends RuleS13 {
	...
	public boolean filter(ArrayList<EventI> matchedEvents, CorrelatorI c)
		...
		String otherCenter = samuState.otherSamuCenter(matchedEvents.get(0).getPropertyValue("centerId"),
