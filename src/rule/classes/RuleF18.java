...
/**
 * La classe <code> RuleF18 </code> implemente la regle F18 contenue dans le
 * cahier des charges
 * 
 * @author Adan Bougherara et Vivien Demeulenaere
 *
 */
public class RuleF18 implements RuleI {
	...
	public ArrayList<EventI> match(EventBaseI eb) {
		...
		for (int i = 0; i < eb.numberOfEvents() && (he == null); i++) {
			...
			if (e instanceof StandardTrucksAvailable && e.hasProperty("centerId")) {
				he = e;
			}
		}
		if (he != null) {
	...
	public void act(ArrayList<EventI> matchedEvents, CorrelatorI c) throws Exception {
		...
		fc.setStandardTrucksAvailable(matchedEvents.get(0).getPropertyValue("centerId"));
